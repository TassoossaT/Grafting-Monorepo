...
### `interface architecture-studio.terrain.worker.TerrainWorkerRequest`

### `property architecture-studio.terrain.worker.TerrainWorkerRequest.centres: Float32Array`

Normalised cell centres, `u` then `v` per cell, both in `[0, 1]`.

### `property architecture-studio.terrain.worker.TerrainWorkerRequest.fieldSize: number`

### `property architecture-studio.terrain.worker.TerrainWorkerRequest.levels: number`

### `property architecture-studio.terrain.worker.TerrainWorkerRequest.scale: number`

### `property architecture-studio.terrain.worker.TerrainWorkerRequest.seed: number`

### `property architecture-studio.terrain.worker.TerrainWorkerRequest.type: "elevate"`

### `type architecture-studio.terrain.worker.TerrainWorkerResponse = { levels: Int32Array; sampled: Float32Array; type: "result" } | { message: string; type: "error" }`
...
### `interface architecture-studio.tileset.worker.TilesetWorkerRequest`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.cellCount: number`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.compatible: Uint32Array`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.facesPerCell: number`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.links: Uint32Array`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.pinned: Uint32Array`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.rotationCycle: Uint32Array`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.seed: number`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.sockets: Uint32Array`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.type: "solve"`

### `property architecture-studio.tileset.worker.TilesetWorkerRequest.weights: Float32Array`

### `type architecture-studio.tileset.worker.TilesetWorkerResponse = { elapsedMs: number; sources: Uint32Array; turns: Uint32Array; type: "result"; variantCount: number } | { message: string; type: "error" }`
