  ...
  const projectJson = `${JSON.stringify(
    {
      ...
      targets: {
        ...
        "docs-generate": {
          executor: "nx:run-commands",
          options: { command: `node tools/scripts/generate-rust-api-docs.mjs ${packageName}` },
          cache: false,
        },
        "docs-check": {
          executor: "nx:run-commands",
          options: { command: `node tools/scripts/generate-rust-api-docs.mjs ${packageName} --check` },
          cache: true,
          inputs: [
            "{projectRoot}/src/**/*",
            "{projectRoot}/Cargo.toml",
            "{workspaceRoot}/Cargo.toml",
            "{workspaceRoot}/tools/rust-public-api-toolchain.txt",
            `{workspaceRoot}/docs/generated/api/rust/${packageName}.md`,
            "{workspaceRoot}/tools/scripts/generate-rust-api-docs.mjs",
            "{workspaceRoot}/tools/rust-api-docgen/src/main.rs",
            "sharedGlobals",
          ],
        },
      },
