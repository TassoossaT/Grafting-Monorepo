...
import { pathCorridorId, pathSubtypeOf } from "../src/features/edit-construction/path-corridor.ts";
import { pathCarvesGround, pathRidesTerrain } from "../src/features/edit-construction/path-recipe.ts";
