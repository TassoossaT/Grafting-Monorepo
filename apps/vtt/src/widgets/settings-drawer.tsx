...
import { Card, Drawer, SelectableChip } from "@/ui";
...
/** The right-side settings/inspector drawer: selection inspector, material picker, and scene metrics -- floats over the map, collapsed by default. */
export function SettingsDrawer(props: SettingsDrawerProps) {
  return (
    <Drawer open={props.open} onClose={props.onClose} title="Configurações" placement="right" size={280}>
      <div className="gm-drawer-panels">
        <Card className="gm-panel-card">
