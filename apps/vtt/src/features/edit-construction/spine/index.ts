...
export { spineGlobalHandleId, spineGlobalHandleId as spinePivotId, spineGlobalHandleOf, spineMemberOf } from "./spine-handle-ids.ts";
export type { SpineGlobalHandleKind, SpineGlobalHandleKind as SpineEndHandleKind } from "./spine-handle-ids.ts";
export { planSpineTransform, spineGlobalHandleAt, spineGlobalHandles, isSpinePivotId, spineEndHandleAt, spineEndHandleId, spineEndHandleOf, spineEndHandles, spinePivotAt, spinePivots } from "./spine-global-handles.ts";
...
export { describeSpineChain, describeSpineChain as describeSlope, gradeSpineSpans, openSpineChain, planSpineChainEdit, planSpineChainEdit as planSlopeEdit, sharedArcCenter, spineChainAt } from "./spine-open-chain.ts";
